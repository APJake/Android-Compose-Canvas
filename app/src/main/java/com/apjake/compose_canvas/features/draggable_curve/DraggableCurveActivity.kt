package com.apjake.compose_canvas.features.draggable_curve
...
class DraggableCurveActivity : ComposeActivity() {
                        ...
                        detectDragGestures(
                            onDragStart = { touchPoint ->
                                if (shouldDrawQuad) {
                                    ...
                                    when {
                                        distanceHandle1 < radius.toPx() -> isDraggingQuadHandle1 =
                                            true
                                        distanceHandle2 < radius.toPx() -> isDraggingQuadHandle2 =
                                            true
                                    ...
                                    val distanceControlPoint1 =
                                        touchPoint.distance(cubicControlPoint1)
                                    val distanceControlPoint2 =
                                        touchPoint.distance(cubicControlPoint2)
                                    when {
                                        distanceHandle1 < radius.toPx() -> isDraggingCubicHandle1 =
                                            true
                                        distanceHandle2 < radius.toPx() -> isDraggingCubicHandle2 =
                                            true
